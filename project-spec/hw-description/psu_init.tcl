...
set psu_mio_init_data {
    ...
    mask_write 0XFF1800C0 0x000000FE 0x000000C0
    ...
    mask_write 0XFF1800C4 0x000000FE 0x000000C0
    ...
    mask_write 0XFF180204 0x0CFFE03F 0x00000000
    ...
    mask_write 0XFF180208 0xFFFFE7FC 0x00B22068
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000003
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000003
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFFE0001
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFFE0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFFD0002
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 1 MS DELAY
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFFD0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
